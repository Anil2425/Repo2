...
WebUI.setText(findTestObject('OrangeHRM/Page_OrangeHRM/input_LOGIN Panel_txtUsername'), 'Admin')

WebUI.setText(findTestObject('OrangeHRM/Page_OrangeHRM/input_Username_txtPassword'), 'admin123')
